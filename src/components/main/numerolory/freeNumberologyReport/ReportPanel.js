                    ...
                    <div className="m-0 text-red-100">
                        {
                            !data ? (
                                ...
                                data.youngStateNumberResponseDTO?(
                                        <div>
                                            <div style={{ color: "red", fontWeight: "bold" }}>{data.youngStateNumberResponseDTO?.name}: Số {data.youngStateNumberResponseDTO?.number}</div>
                                            <div className="text-blue-900">{data.youngStateNumberResponseDTO?.description}</div>

                                            <div style={{ color: "red", fontWeight: "bold" }}>{data.matureStateNumberResponseDTO?.name}: Số {data.matureStateNumberResponseDTO?.number}</div>
                                            <div className="text-blue-900">{data.matureStateNumberResponseDTO?.description}</div>

                                            <div style={{ color: "red", fontWeight: "bold" }}>{data.oldStateNumberResponseDTO?.name}: Số {data.oldStateNumberResponseDTO?.number}</div>
