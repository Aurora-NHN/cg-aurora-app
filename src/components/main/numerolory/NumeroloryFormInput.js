...
function NumeroloryFormInput() {
    ...
    function updateDayOfBirthList(selectedMonth, isLeap) {
        let updatedDayOfBirthList = dayOfBirthListDefault;

        switch (selectedMonth) {
            case "Tháng 2":
                updatedDayOfBirthList = isLeap ? dayOfBirthList29Days : dayOfBirthList28Days;
                break;
            case "Tháng 4":
            case "Tháng 6":
            case "Tháng 9":
    ...
    const handleSubmit = (event) => {
        ...
        // Thực hiện xử lý gửi form ở đây
...
export default NumeroloryFormInput;
