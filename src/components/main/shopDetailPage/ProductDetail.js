      ...
      <div className="product">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="value">
                    <select
                      id="pa_color"
                      className="wc-default-select"
                      name="attribute_pa_color"
                      data-attribute_name="attribute_pa_color"
                    >
                      <option value="">Choose an option</option>
                      <option value="blue" className="attached enabled">
                        Blue
                      </option>
                    </select>
                  </td>
                ...
                <tr>
                  ...
                  <td className="value">
                    ...
                    >
                      <option value="">Choose an option</option>
                      <option value="x-small" className="attached enabled">
                        X Small
                      </option>
                      <option value="small" className="attached enabled">
                        Small
                      </option>
                      <option value="medium" className="attached enabled">
                        Medium
                      </option>
                      <option value="large" className="attached enabled">
                        Large
                      </option>
                      <option value="x-large" className="attached enabled">
                        X Large
                      </option>
                      <option value="xx-large" className="attached enabled">
                        XX Large
                      </option>
                      <option value="xxx-large" className="attached enabled">
                        XXX Large
                      </option>
                    </select>
        ...
        <div className="woocommerce-tabs wc-tabs-wrapper">
          <ul className="tabs wc-tabs" role="tablist">
            ...
            <li
              className="additional_information_tab active"
            ...
            <table className="shop_attributes">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      X Small, Small, Medium, Large, X Large, XX Large, XXX
                      Large
                    </p>
                  </td>
                </tr>
