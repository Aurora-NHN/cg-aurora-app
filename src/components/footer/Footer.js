            ...
            <footer className="page_footer ds ms s-py-90 s-pb-lg-60 s-pt-xl-150 s-pb-xl-120">
                <div className="container">
                    <div className="row align-center">
                        <div className="col-xl-5 col-lg-5 text-center text-lg-left animate animated fadeInUp" data-animation="fadeInUp">
                        ...
                        <div className="col-xl-2 col-lg-2 align-self-start text-center text-lg-left animate animated fadeInUp"
                        ...
                        <div className="col-xl-3 col-lg-3 align-self-start text-center text-lg-left animate animated fadeInUp"
                             data-animation="fadeInUp">
